  ...
  return (
    <motion.div className="flex items-center gap-3 mb-5"
      ...
      <div className="text-center">
        ...
        <p style={{ fontFamily: 'Pretendard, sans-serif', fontSize: '8px', color: '#5a4e44',
                    letterSpacing: '0.2em', textTransform: 'uppercase' }}>{titleKr}</p>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '20px',
                     fontWeight: 300, color: '#c9a96e', letterSpacing: '0.06em' }}>{title}</h2>
      </div>
...
function KoreanBorder({ children, color = 'rgba(201,169,110,0.18)' }: {
  ...
  return (
    <div className="relative" style={{ border: `1px solid ${color}`, padding: 1 }}>
      <div style={{ border: `1px solid ${color}`, opacity: 0.4 }}>
        {children}
      </div>
    </div>
  );
...
export function FullScript() {
  ...
  // ← narrativeContent.ts 단일 호출 — 모든 내러티브 데이터 수신
  const { zodiac, dayMaster, scenario, pastData, youthData, futureData, gyeokguk, pastLife, kDrama, luckyData } = getNarrative(saju);
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-5 text-center">
          <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:0.15 }}
            ...
            <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px',
                           color:'#5a4e44', letterSpacing:'0.22em' }}>🇰🇷 대한민국 평행 정체성</span>
          </motion.div>
          <motion.h1 initial={{ opacity:0, y:14 }} animate={{ opacity:1, y:0 }} transition={{ delay:0.3 }}
            style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'52px',
                     fontWeight:300, color:'#f5f0e8', lineHeight:1 }}>
            {identity.fullName}
          </motion.h1>
          <motion.p initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:0.5 }}
            style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'15px',
                     fontStyle:'italic', color:'#8a7255', marginTop:5 }}>
            {identity.fullNameRomanized}
          </motion.p>
          <motion.div className="mt-4 flex flex-wrap gap-2 justify-center"
            initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ delay:0.65 }}>
            <span style={{ background:'rgba(201,169,110,0.12)', border:'1px solid rgba(201,169,110,0.26)',
                           fontFamily:'Pretendard, sans-serif', fontSize:'9px',
                           color:'#c9a96e', padding:'2px 9px' }}>{identity.careerKr}</span>
            <span style={{ background:`${domLabel.color}10`, border:`1px solid ${domLabel.color}25`,
                           fontFamily:'Pretendard, sans-serif', fontSize:'9px',
      ...
      <div className="px-4 pt-6 pb-16 flex flex-col gap-9">
          ...
          <div className="relative">
            ...
            <motion.div className="relative flex gap-4 mb-6"
              ...
              <div className="shrink-0 w-11 h-11 flex flex-col items-center justify-center z-10"
                ...
                <span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'18px', color:'#5a4e44', lineHeight:1 }}>年</span>
                <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'6px', color:'#3a3028', marginTop:1 }}>과거</span>
              </div>
              <div className="flex-1 pt-1 pb-5" style={{ borderBottom:'1px solid rgba(201,169,110,0.07)' }}>
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'22px', color:'#5a4e44', lineHeight:1 }}>{saju.year.stem}{saju.year.branch}</span>
                  <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#3a3028', letterSpacing:'0.12em' }}>년주 · 유년기</span>
                </div>
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44', letterSpacing:'0.1em', marginBottom:6 }}>{pastData.keyword}</p>
                <h4 style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'17px', color:'#8a7255', fontWeight:300, marginBottom:8 }}>{pastData.title}</h4>
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#6b5d51', lineHeight:1.85 }}>{pastData.narrative}</p>
                <div className="mt-4 p-3" style={{ border:'1px solid rgba(201,169,110,0.07)', background:'rgba(201,169,110,0.015)' }}>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#3a3028', letterSpacing:'0.12em', marginBottom:6 }}>月柱 · 청춘기 ({saju.month.stem}{saju.month.branch})</p>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44', letterSpacing:'0.08em', marginBottom:5 }}>{youthData.keyword}</p>
                  <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'15px', color:'#6b5d51', fontWeight:300, marginBottom:6 }}>{youthData.title}</p>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#5a4e44', lineHeight:1.8 }}>{youthData.narrative}</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div className="relative flex gap-4 mb-6"
              ...
              <div className="flex-1 pt-1 pb-5" style={{ borderBottom:'1px solid rgba(201,169,110,0.07)' }}>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#5a4e44', letterSpacing:'0.12em' }}>일주 · 현재의 나</span>
                </div>
                ...
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#8a7255', lineHeight:1.85, marginBottom:10 }}>{identity.personality}</p>
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div key={item.label} className="p-2.5 text-center"
                      ...
                      <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'7px', color:'#3a3028' }}>{item.label}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <motion.div className="relative flex gap-4"
              ...
              <div className="flex-1 pt-1">
                <div className="flex items-center gap-2 mb-1">
                  <span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'22px', color:'rgba(201,169,110,0.45)', lineHeight:1, filter:'blur(1.5px)' }}>{saju.hour.stem}{saju.hour.branch}</span>
                  <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#3a3028', letterSpacing:'0.12em' }}>시주 · 미래의 나</span>
                </div>
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#3a3028', letterSpacing:'0.1em', marginBottom:6 }}>{futureData.keyword} · 절정 {futureData.peak}</p>
                ...
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#6b5d51', lineHeight:1.85, marginBottom:14 }}>{futureData.narrative}</p>
                <div className="p-4 relative overflow-hidden"
                  ...
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#5a4e44', letterSpacing:'0.18em', marginBottom:6 }}>✦ 절정의 시기</p>
                  <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'26px', color:'#c9a96e', lineHeight:1, marginBottom:4 }}>{futureData.peak}</p>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'10px', color:'#5a4e44', lineHeight:1.7 }}>
                    한국에서라면 이 시기에 당신은<br/>
                    <span style={{ color:'#8a7255' }}>"{dayMaster.koreanStyle}"</span>으로<br/>
                    인생의 정점을 맞이합니다.
                  </p>
                </div>
              </div>
            ...
            <div className="p-4" style={{ background:'rgba(255,255,255,0.01)' }}>
              <div className="flex items-center gap-4 mb-5">
                <div className="w-16 h-16 flex flex-col items-center justify-center shrink-0"
                  ...
                  <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'7px', color:'#5a4e44', marginTop:2 }}>일간</span>
                </div>
                <div>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44', letterSpacing:'0.15em', marginBottom:3 }}>DAY MASTER</p>
                  <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'22px', color:'#f5f0e8', fontWeight:300, lineHeight:1.1 }}>{dayMaster.title}</p>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'10px', color:'#8a7255', marginTop:2 }}>자연물: {dayMaster.nature} · 한국에서라면 "{dayMaster.koreanStyle}"</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3 mb-5">
                <div className="p-3" style={{ border:'1px solid rgba(74,222,128,0.15)', background:'rgba(74,222,128,0.03)' }}>
                  ...
                  {dayMaster.strength.map(s => (
                    <p key={s} style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#6b5d51', marginBottom:5, lineHeight:1.5 }}>· {s}</p>
                  ))}
                </div>
                <div className="p-3" style={{ border:'1px solid rgba(251,146,60,0.15)', background:'rgba(251,146,60,0.03)' }}>
                  ...
                  {dayMaster.caution.map(c => (
                    <p key={c} style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#6b5d51', marginBottom:5, lineHeight:1.5 }}>· {c}</p>
                  ))}
                </div>
              </div>
              <div style={{ borderTop:'1px solid rgba(201,169,110,0.08)', paddingTop:14 }}>
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#3a3028', letterSpacing:'0.15em', marginBottom:10 }}>행운의 기운</p>
                <div className="flex gap-3 flex-wrap">
                  <div className="flex items-center gap-2 px-3 py-2"
                    ...
                    <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#8a7255' }}>행운색: {dayMaster.luckyColor}</span>
                  </div>
                  <div className="flex items-center gap-2 px-3 py-2"
                    ...
                    <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#8a7255' }}>행운 숫자</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
          ...
          <div className="p-4" style={{ border:'1px solid rgba(201,169,110,0.13)', background:'linear-gradient(180deg, rgba(201,169,110,0.04), rgba(201,169,110,0.01))' }}>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44', letterSpacing:'0.15em', marginBottom:4 }}>PAST LIFE CONNECTION</p>
            ...
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#8a7255', lineHeight:1.8 }}>
              {pastLife.desc}
            </p>
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
          ...
          <div className="p-4 mb-4" style={{ border:`1px solid ${domLabel.color}22`, background:`linear-gradient(145deg, ${domLabel.color}06, transparent)` }}>
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#5a4e44', letterSpacing:'0.15em', marginBottom:2 }}>격국(格局)</p>
                <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'20px', color:domLabel.color, fontWeight:300 }}>{gyeokguk.hanja}</p>
              </div>
            </div>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#6b5d51', lineHeight:1.8 }}>{gyeokguk.desc}</p>
          </div>
              ...
              {elementRadar.map(el => {
                ...
                return (
                  <div key={el.element} className="flex items-center gap-2.5">
                    ...
                    <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'10px', color:'#5a4e44', minWidth:30, textAlign:'right' }}>{el.value}%</span>
                  </div>
                );
              })}
            </div>
            <div className="mt-4 p-3" style={{ background:'rgba(201,169,110,0.025)', border:'1px solid rgba(201,169,110,0.08)' }}>
              <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#6b5d51', lineHeight:1.8 }}>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'22px', color:'#3a3028', fontWeight:300 }}>({saju.year.branch})</span>
                  </div>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44' }}>{zodiac.animal} Year</p>
                </div>
              </div>
              <div style={{ height:1, background:'rgba(201,169,110,0.08)', marginBottom:14 }}/>
              <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#8a7255', lineHeight:1.85 }}>{zodiac.trait}</p>
              <div className="mt-4 p-3" style={{ border:'1px solid rgba(201,169,110,0.1)', background:'rgba(201,169,110,0.02)' }}>
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#3a3028', letterSpacing:'0.15em', marginBottom:8 }}>한국에서의 띠 궁합</p>
                <div className="flex gap-2 flex-wrap">
                  {(['🐉','🐒','🐂'].map((e, i) => (
                    <span key={i} style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#6b5d51', padding:'3px 8px', border:'1px solid rgba(201,169,110,0.12)' }}>
                      {e} 좋은 궁합
                    </span>
                  )))}
                </div>
          ...
          <div className="p-4" style={{ border:'1px solid rgba(201,169,110,0.13)', background:'rgba(255,255,255,0.01)' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'10px', color:'#5a4e44' }}>{identity.careerKr} · 일간 {saju.day.stem}({saju.day.stemKr})</p>
              </div>
            </div>
            <div style={{ height:1, background:'rgba(201,169,110,0.08)', marginBottom:12 }}/>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#8a7255', lineHeight:1.85 }}>{identity.careerDescription}</p>
            <div style={{ height:1, background:'rgba(201,169,110,0.08)', margin:'12px 0' }}/>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#6b5d51', lineHeight:1.8, fontStyle:'italic' }}>{identity.personality}</p>
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
          ...
          <div className="p-4 relative overflow-hidden" style={{ border:'1px solid rgba(201,169,110,0.13)', background:'rgba(255,255,255,0.01)' }}>
            ...
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#8a7255', lineHeight:1.8, position:'relative', zIndex:1 }}>
              {kDrama.desc}
            </p>
          </div>
        </motion.div>
              ...
              {[
                ...
                <motion.div key={s.time} className="mb-4"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#5a4e44', letterSpacing:'0.12em', marginBottom:4 }}>{s.time}</p>
                      <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#8a7255', lineHeight:1.8 }}>{s.text}</p>
                    </div>
                  </div>
        ...
        <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
          ...
          <div className="p-4 relative overflow-hidden"
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#5a4e44', letterSpacing:'0.18em', marginBottom:3 }}>DESTINY MATCH</p>
                <h3 style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'30px', fontWeight:400, color:'#f5f0e8', lineHeight:1 }}>{soulmate.name}</h3>
                <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'13px', fontStyle:'italic', color:'#8a7255', marginTop:1 }}>{soulmate.nameRomanized}</p>
              </div>
              <div className="text-center shrink-0 ml-3">
                ...
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'7px', color:'#3a3028', marginTop:3 }}>궁합 점수</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-1.5 mb-4">
              {[soulmate.trait1, soulmate.trait2, soulmate.trait3].map(t => (
                <span key={t} style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#8a7255', padding:'2px 8px', border:'1px solid rgba(201,169,110,0.15)', background:'rgba(201,169,110,0.03)' }}>{t}</span>
              ))}
            </div>
            <div style={{ height:1, background:'rgba(201,169,110,0.08)', marginBottom:12 }}/>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#6b5d51', lineHeight:1.85 }}>{soulmate.description}</p>
            <div className="mt-4 grid grid-cols-3 gap-2">
              {[
                ...
                <div key={item.label} className="p-2 text-center" style={{ border:'1px solid rgba(201,169,110,0.1)', background:'rgba(201,169,110,0.02)' }}>
                  ...
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'7px', color:'#3a3028', marginTop:3 }}>{item.label}</p>
                </div>
              ))}
            </div>
          ...
          <div style={{ border:'1px solid rgba(201,169,110,0.13)', overflow:'hidden' }}>
            <div className="relative" style={{ height:150 }}>
              ...
              <div className="absolute bottom-4 left-4">
                ...
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'10px', color:'#8a7255' }}>{neighborhood.nameKr}</p>
              </div>
            ...
            <div className="p-4">
              <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#6b5d51', lineHeight:1.8, marginBottom:10 }}>{neighborhood.description}</p>
              <div className="flex flex-wrap gap-1.5">
                {neighborhood.vibe.split(' · ').map(v => (
                  <span key={v} style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44', padding:'2px 8px', border:'1px solid rgba(201,169,110,0.12)' }}>{v}</span>
                ))}
              </div>
            </div>
          </div>
        ...
        <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
          ...
          <div className="p-4" style={{ border:'1px solid rgba(201,169,110,0.13)', background:'rgba(255,255,255,0.01)' }}>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#8a7255', lineHeight:1.8, marginBottom:16 }}>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={item.label} className="p-3" style={{ border:'1px solid rgba(201,169,110,0.08)', background:'rgba(201,169,110,0.02)' }}>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44', letterSpacing:'0.1em', marginBottom:6 }}>
          ...
          <KoreanBorder>
            <div className="p-4" style={{ background:'rgba(255,255,255,0.01)' }}>
              <div className="text-center mb-5">
                ...
                <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'14px', fontStyle:'italic', color:'#8a7255', marginTop:4 }}>{identity.fullNameRomanized}</p>
              </div>
              ...
              <div className="mb-4 p-3" style={{ border:`1px solid ${elLabel.color}18`, background:`${elLabel.color}05` }}>
                ...
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px', color:'#8a7255', lineHeight:1.85 }}>{identity.nameMeaning}</p>
              </div>
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div key={item.num} className="flex items-start gap-3 p-3"
                    ...
                    <span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'22px', color:'rgba(201,169,110,0.4)', lineHeight:1 }}>{item.num}</span>
                    <div>
                      <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'10px', color:'#c9a96e', marginBottom:2 }}>{item.title}</p>
                      <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'11px', color:'#5a4e44', lineHeight:1.7 }}>{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <motion.div className="text-center pt-4"
          ...
          <motion.button onClick={() => navigate('/')} className="mt-7"
            style={{ fontFamily:'Pretendard, sans-serif', fontSize:'10px', letterSpacing:'0.14em',
                     color:'#5a4e44', background:'none', border:'none', cursor:'pointer', textDecoration:'underline' }}>
