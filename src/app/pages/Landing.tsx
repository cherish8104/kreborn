  ...
  return (
    <div className="text-center mb-5">
      <p style={{ fontFamily: 'Pretendard, sans-serif', fontSize: '9px',
                  color: '#5a4e44', letterSpacing: '0.28em', marginBottom: 6 }}>{kr}</p>
      <SectionDivider />
      <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '28px',
                   fontWeight: 300, color: '#f5f0e8', letterSpacing: '0.06em', lineHeight: 1.2 }}>{en}</h2>
    </div>
  );
}
    ...
    <div style={{ backgroundColor: '#0a0a0a' }}>
      ...
      <div ref={heroRef} className="relative w-full flex flex-col items-center justify-center"
        ...
        <motion.div className="absolute inset-0 z-0" style={{ y: heroBgY }}>
          <img src={SEOUL_BG} alt="Seoul dawn" className="w-full object-cover"
               style={{ height: '115%', top: '-7%', position: 'absolute',
        ...
        <motion.div className="relative z-20 flex flex-col items-center text-center w-full px-10"
          ...
          <motion.div className="mb-4 flex items-center gap-2"
            ...
            <span style={{ fontFamily:'Pretendard, sans-serif', color:'#3a3028', fontSize:'8px',
          ...
          <motion.div className="mb-7 flex items-center gap-2"
            ...
            <span style={{ fontFamily:'Pretendard, sans-serif', color:'#c9a96e', fontSize:'9px',
                           letterSpacing:'0.22em', textTransform:'uppercase' }}>
              평행우주 속 나의 한국 정체성
            </span>
          ...
          <motion.h1 className="mb-2"
            style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'clamp(42px, 13vw, 58px)',
          ...
          <motion.p className="mb-9 px-4"
            style={{ fontFamily:'Pretendard, sans-serif', fontSize:'13px',
          ...
          <motion.button onClick={() => navigate('/registry')}
            ...
            style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px',
            ...
            {[
              ...
              <motion.div key={el.char} className="flex flex-col items-center gap-1"
                ...
                <span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'20px',
                               fontWeight:500, color:el.color, lineHeight:1 }}>{el.char}</span>
                <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px',
                               color:'#6b5d51', letterSpacing:'0.08em' }}>{el.kr}</span>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="px-5 py-16" style={{ borderTop:'1px solid rgba(201,169,110,0.07)' }}>
        <FadeIn>
          <div className="text-center mb-8">
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44',
                        letterSpacing:'0.28em', marginBottom:6 }}>THE DIFFERENCE</p>
            <SectionDivider />
        ...
        <FadeIn delay={0.1}>
          <div className="mb-2 p-5" style={{ border:'1px solid rgba(255,255,255,0.05)',
                                              background:'rgba(255,255,255,0.015)' }}>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#3a3028',
                        letterSpacing:'0.15em', marginBottom:12 }}>일반 이름 생성기</p>
              ...
              <div className="p-5 relative overflow-hidden"
                ...
                <div className="flex items-start gap-3 mb-3">
                  <div className="shrink-0 w-11 h-11 flex flex-col items-center justify-center"
                    ...
                    <span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'20px',
                                   color:item.color, lineHeight:1 }}>{item.icon}</span>
                    <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'6px',
                                   color:item.color, opacity:0.7, marginTop:1 }}>{item.iconLabel}</span>
                  </div>
                  <div>
                    <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'18px',
                                 fontWeight:300, color:'#f5f0e8', lineHeight:1.2 }}>{item.title}</p>
                    <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px',
                                 color:item.color, opacity:0.8, marginTop:1 }}>{item.titleEn}</p>
                  </div>
                </div>
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px',
                             color:'#5a4e44', lineHeight:1.8, marginBottom:10 }}>{item.desc}</p>
                <div className="pt-3" style={{ borderTop:`1px solid ${item.color}15` }}>
                  <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'7px',
                               color:'#3a3028', letterSpacing:'0.12em', marginBottom:3 }}>SAMPLE RESULT</p>
                  <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'15px',
                               color:item.color }}>{item.sample}</p>
        ...
        <div className="relative z-10">
          ...
          <FadeIn delay={0.1}>
            <div className="relative overflow-hidden mb-6"
                 style={{ background:'linear-gradient(145deg, #161410, #0e0c0a)',
              ...
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'7px', color:'#c9a96e',
                                 padding:'1px 5px', border:'1px solid rgba(201,169,110,0.28)' }}>SAMPLE</span>
                </div>
              </div>
              <div style={{ height:1, background:'linear-gradient(to right, transparent, #c9a96e22, transparent)', marginBottom:14 }}/>
              <div className="text-center mb-3">
                <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'46px', fontWeight:400,
                            color:'#f5f0e8', lineHeight:1, letterSpacing:'0.04em' }}>이도윤</p>
                <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'13px',
                            fontStyle:'italic', color:'#8a7255', marginTop:3 }}>Do-yun Lee</p>
              </div>
          ...
          <FadeIn delay={0.18}>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#5a4e44',
                        letterSpacing:'0.18em', marginBottom:12 }}>FULL SCRIPT INCLUDES</p>
              ...
              <div key={String(item.icon)} className="flex items-center gap-3 mb-3.5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    {item.free
                      ? <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'7px', color:'#4ade80',
                                       padding:'1px 5px', border:'1px solid #4ade8028' }}>FREE</span>
                      : <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'7px', color:'#c9a96e',
                                       padding:'1px 5px', border:'1px solid rgba(201,169,110,0.28)' }}>₩5,900</span>
                    }
                  </div>
      ...
      <section className="px-5 py-16" style={{ borderTop:'1px solid rgba(201,169,110,0.07)' }}>
        <FadeIn>
          ...
          <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'13px', color:'#6b5d51',
          ...
          {ELEMENTS_DETAIL.slice(0,2).map((el,i) => (
            <FadeIn key={el.char} delay={i*0.07}>
              <div className="p-4 text-center"
                   style={{ border:`1px solid ${el.color}18`,
                            background:`linear-gradient(180deg, ${el.color}05 0%, transparent 100%)` }}>
                <motion.span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'34px',
          ...
          {ELEMENTS_DETAIL.slice(2).map((el,i) => (
            <FadeIn key={el.char} delay={(i+2)*0.07}>
              <div className="p-3 text-center"
                   style={{ border:`1px solid ${el.color}18`,
                            background:`linear-gradient(180deg, ${el.color}05 0%, transparent 100%)` }}>
                <motion.span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'30px',
            ...
            {STATS.map(s => (
              <div key={s.num} className="text-center p-4"
                ...
                <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'30px',
                             fontWeight:300, color:'#c9a96e', lineHeight:1 }}>{s.num}</p>
              ...
              <div className="flex gap-4">
                <div className="shrink-0 w-11 h-11 flex flex-col items-center justify-center"
                  ...
                  <span style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'16px',
                                 color:'#c9a96e', lineHeight:1 }}>{step.num}</span>
                </div>
                <div className="flex-1 pt-1">
                  <div className="flex items-center gap-2 mb-1.5">
                    <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'19px',
                                 fontWeight:300, color:'#f5f0e8' }}>{step.title}</p>
                  ...
                  <span style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px', color:'#c9a96e',
                                 padding:'2px 8px', border:'1px solid rgba(201,169,110,0.28)',
                                 background:'rgba(201,169,110,0.05)' }}>{step.detail}</span>
                </div>
              </div>
              {i < STEPS.length-1 && (
              ...
              <div className="p-5 relative overflow-hidden"
                ...
                <span className="absolute top-3 right-4"
                      style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'52px',
                               color:'rgba(201,169,110,0.05)', lineHeight:1 }}>"</span>
                ...
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'12px',
                             color:'#6b5d51', lineHeight:1.82, fontStyle:'italic' }}>{t.quote}</p>
      ...
      <section className="px-5 py-20 relative overflow-hidden"
        ...
        <div className="relative z-10 text-center">
          <FadeIn>
            <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'9px',
                        color:'#5a4e44', letterSpacing:'0.25em', marginBottom:10 }}>지금 이 순간에도</p>
            <motion.h2
            ...
            <div className="flex items-center gap-0 mb-8"
              ...
              <div className="flex-1 py-4 px-4 text-center">
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#5a4e44',
                             letterSpacing:'0.1em', marginBottom:3 }}>이름 + 직업 성향</p>
              ...
              <div className="flex-1 py-4 px-4 text-center">
                <p style={{ fontFamily:'Pretendard, sans-serif', fontSize:'8px', color:'#5a4e44',
                             letterSpacing:'0.08em', marginBottom:3 }}>7가지 프리미엄 분석</p>
            ...
            <motion.button onClick={() => navigate('/registry')} className="w-full mb-4"
              style={{ padding:'18px 0', fontFamily:'Pretendard, sans-serif', fontSize:'13px',
                       letterSpacing:'0.2em', textTransform:'uppercase',
