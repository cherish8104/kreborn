...
export function Reveal() {
  ...
  return (
     ...
     * ────────────────────────────────────────────────────────────────
     */
    <div className="relative w-full" style={{ height: '100svh', overflowY: 'auto',
      ...
      <div className="flex items-center justify-between px-5 py-4"
        ...
        <div className="flex items-center gap-2">
          ...
          <span style={{ fontFamily: 'Pretendard, sans-serif', fontSize: '8px',
                         color: '#5a4e44', letterSpacing: '0.18em' }}>IDENTITY REVEALED</span>
        </div>
      </div>

      {/* ── ResultCard (preview mode) ── */}
      <div className="px-4 pt-5"
           style={{ paddingBottom: showPaywall ? sheetH + 24 : 40 }}>
      ...
      <AnimatePresence>
        {showPaywall && (
          <>
            {/* Gradient scrim — also absolute so it stays in the container */}
            <motion.div
            ...
            <motion.div
              ...
              style={{ position: 'sticky', bottom: 0, left: 0, right: 0, zIndex: 50,
                       width: '100%' }}
              ...
              <div className="pointer-events-none"
                   style={{ position: 'absolute', bottom: '100%', left: 0, right: 0, height: 80,
                            background: 'linear-gradient(to top, rgba(10,10,10,0.96), transparent)' }} />

              <div style={{ background: 'rgba(12,10,8,0.99)', backdropFilter: 'blur(24px)',
                            borderTop: '1px solid rgba(201,169,110,0.28)',
                            borderRadius: '20px 20px 0 0' }}>

                {/* Handle */}
                <div className="flex justify-center pt-3.5 mb-1">
                  <div style={{ width: 34, height: 3.5, borderRadius: 2,
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-right shrink-0 ml-3">
                          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '26px',
                                       color: '#c9a96e', lineHeight: 1 }}>$4.5</p>
                        ...
                        {FEATURES.map(f => (
                          <div key={f.text} className="flex items-center gap-2 px-3 py-2.5"
                            ...
                            <span style={{ fontFamily: 'Pretendard, sans-serif', fontSize: '11px',
                                           color: '#e6e0d4', lineHeight: 1.4 }}>{f.text}</span>
                          </div>
                        ))}
                      </div>

                      <motion.button onClick={() => setPayStep('form')} className="w-full mb-3"
                        style={{ padding: '15px', fontFamily: 'Pretendard, sans-serif',
                  ...
                  {payStep === 'success' && (
                    <motion.div className="flex flex-col items-center py-8"
                      ...
                      <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '22px',
                                   color: '#f5f0e8', fontStyle: 'italic' }}>Identity Unlocked</p>
                      <p style={{ fontFamily: 'Pretendard, sans-serif', fontSize: '11px',
                                   color: '#a39481', marginTop: 6 }}>Opening your Full Script…</p>
                    </motion.div>
                  )}
                </div>
              </div>
